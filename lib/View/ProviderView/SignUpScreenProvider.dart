...
import 'package:gp/ViewModel/SignUP/ViewModel/SignUpScreen_ViewModel.dart';
...
class SignUpScreenProvider extends StatefulWidget {
  static const String routeName = 'signUpScreenP';
    ...
    return BlocListener<SignUpViewMode, SignUpState>(
      ...
      listener: (context, state) {
        if (state is SignUpLoadingState) {
          ...
          Navigator.pushReplacementNamed(context, HomeScreenProvider.routeName,
                    ...
                    children: [
                        ...
                        child: Form(
                          ...
                          child: Column(
                            children: [
                              ...
                              TextFieldItem(
                                fieldName:
                                AppLocalizations.of(context)!.confirmationPassword,
                                hintText:
                                AppLocalizations.of(context)!.enterConfirmPass,
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            setState(() {});
                            await viewModel.signUpProvider();
                          },
                            ...
                            child: Center(
                              child: Text(
                                ...
                                style: Theme.of(context)
                                    .textTheme
                                    .titleLarge!
                                    .copyWith(color: MyTheme.backgroundLight, fontSize: 20.sp),
                              ),
                            ),
                          ),
                        ),
